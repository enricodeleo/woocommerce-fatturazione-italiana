...
Versione di Woocommerce richiesta: 3.5
Testato fino alla versione di Woocommerce: 8.6
...
= 2.2.0 =
* NEW: Aggiunto supporto completo per HPOS (High-Performance Order Storage)
* NEW: Compatibilità testata con WordPress 6.6.1
* NEW: Compatibilità testata con WooCommerce 8.6
* NEW: Compatibilità testata con PHP 8.3

= 2.1.11 =
FIX images path

[Le versioni precedenti sono state omesse per brevità]
